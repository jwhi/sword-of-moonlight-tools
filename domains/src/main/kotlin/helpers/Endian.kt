...
enum class Endian {
     ...
     */
    abstract fun getShort(bytes: ByteArray, byteOffset: Int): Short
     ...
     */
    fun setShort(bytes: ByteArray, byteOffset: Int, value: Short) {
     ...
     * `byteOffset + 2` must be less than or equal to the length of [bytes].
     */
    abstract fun setShort(bytes: ByteArray, byteOffset: Int, value: Int)
     ...
     * `byteOffset + 2` must be less than or equal to the length of this object.
     */
    fun getUShort(bytes: ByteArray, byteOffset: Int): UShort = getShort(bytes, byteOffset).toUShort()
     ...
     * `byteOffset + 2` must be less than or equal to the length of [bytes].
     */
    fun setUShort(bytes: ByteArray, byteOffset: Int, value: UShort) {
     ...
     * `byteOffset + 2` must be less than or equal to the length of [bytes].
     */
    fun setUShort(bytes: ByteArray, byteOffset: Int, value: UInt) {
        setShort(bytes, byteOffset, value.toShort())
    }
     ...
     */
    abstract fun getInt(bytes: ByteArray, byteOffset: Int): Int
     ...
     * `byteOffset + 4` must be less than or equal to the length of this object.
     */
    abstract fun setInt(bytes: ByteArray, byteOffset: Int, value: Int)
     ...
     * `byteOffset + 4` must be less than or equal to the length of this object.
     */
    fun getUInt(bytes: ByteArray, byteOffset: Int): UInt = getInt(bytes, byteOffset).toUInt()
     ...
     * `byteOffset + 4` must be less than or equal to the length of this object.
     */
    fun setUInt(bytes: ByteArray, byteOffset: Int, value: UInt) {
     ...
     */
    abstract fun getLong(bytes: ByteArray, byteOffset: Int): Long
     ...
     * `byteOffset + 8` must be less than or equal to the length of this object.
     */
    abstract fun setLong(bytes: ByteArray, byteOffset: Int, value: Long)
     ...
     * `byteOffset + 8` must be less than or equal to the length of this object.
     */
    fun getULong(bytes: ByteArray, byteOffset: Int): ULong = getLong(bytes, byteOffset).toULong()
     ...
     * `byteOffset + 8` must be less than or equal to the length of this object.
     */
    fun setULong(bytes: ByteArray, byteOffset: Int, value: ULong) {
        setLong(bytes, byteOffset, value.toLong())
    }

    companion object {
        val DEFAULT = Endian.Little
    }
}
